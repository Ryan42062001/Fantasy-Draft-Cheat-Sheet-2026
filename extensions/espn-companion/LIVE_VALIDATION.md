...
1. Reload extension version 0.9.0 and refresh ESPN plus The War Room before entering the draft room. Loading before the draft starts is important because WebSocket observation begins at document start.
...
2. Keep Companion 0.9.0, ESPN, and The War Room open with matching teams, slot, and rounds.
