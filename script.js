...
var ESPN_COMPANION_MIN_VERSION = '0.9.5';
...
function requestFantasyProsApiRefresh() {
  ...
  setTimeout(function() {
    ...
    if (target && target.classList.contains('working')) {
      setRankingsRefreshMessage('No response from the companion after 15 seconds. Reload extension 0.9.5 and refresh this page.', 'error');
    }
  }, 15000);
}
